...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra al usuario el pais que representa el atleta
	 */
	private void ejecutarPaisDelAtleta()
	{
		System.out.println("\n" + "El pais que representa el atleta es" + "\n");
		
		String atleta = input("Por favor ingrese el nombre del atleta que quiere consultar");
		Map<String, List<Map<String, Object>>> atletas = calculadora.PaisDelAtleta(atleta);
		if (atletas == null)
		{
		...
		else
		{
			...
			{
				String nombre = (String) atleta;
				String pais = (String) datos.get("pais");
				System.out.println("El atleta" + nombre + "pertenece al pais" + pais + "\n");
			}
		}
