...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta el pais de un atleta dado por parametro
	 * @return Retorna el pais del atleta.
	 */
	public Map<String, List<Map<String, Object>>>PaisDelAtleta(String nombreAtleta)
	{
		Map<String, List<Map<String,Object>>> resultado = null;
		Atleta elatleta = buscarAtleta(nombreAtleta);
		if (elatleta != null)
		{
			Map<String, List<Map<String, Object>>> darPais = (Map<String, List<Map<String, Object>>>) elatleta.darPais();
			resultado = darPais;
		}
		return resultado;
	}
